...
public class ImageText extends LinearLayout {
    ...
    public void setChecked(int itemID) {
        ...
        switch (itemID) {
            case Constant.BTN_FLAG_NOTIFY:
                checkDrawableId = R.drawable.notify_select;
                break;
            case Constant.BTN_FLAG_CLASS:
                checkDrawableId = R.drawable.class_select;
                break;
            case Constant.BTN_FLAG_PERSONAL:
                checkDrawableId = R.drawable.personal_select;
                break;
            default:
                break;
        }
